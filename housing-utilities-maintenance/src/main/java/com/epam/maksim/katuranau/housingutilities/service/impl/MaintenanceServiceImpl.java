...
import com.epam.maksim.katuranau.housingutilities.service.MaintenanceService;
...
public class MaintenanceServiceImpl implements MaintenanceService {
    ...
    @Autowired
    public MaintenanceServiceImpl(final MaintenanceServiceRepository maintenanceServiceRepository,
    ...
    public CalculatedCostResponse getUserCostsByUserIdAndMonth(final Integer userId, final LocalDate dateTime) {
        ...
        BigDecimal totalSpace = maintenanceServiceRepository.getTotalSpaceByMonthAndUserId(userId,
    ...
    private List<LocalDate> createListOfAvailableDates(final Integer userId) {
        LocalDate minMonth = getStartOfTheMonth(maintenanceServiceRepository.getMinMonth(userId));
        LocalDate maxMonth = getStartOfTheMonth(maintenanceServiceRepository.getMaxMonth(userId));
