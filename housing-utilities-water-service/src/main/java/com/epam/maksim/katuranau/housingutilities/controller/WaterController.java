...
public class WaterController {
    ...
    @Autowired
    public WaterController(final WaterService maintenanceService) {
        this.waterService = maintenanceService;
    }
    ...
    public CalculatedCostResponse calculate(@RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date,
        ...
        return waterService.getUserCostsByUserIdAndMonth(customPrincipal.getUserId(), date);
    }
}
