...
import com.epam.maksim.katuranau.housingutilities.service.WaterService;
...
public class WaterServiceImpl implements WaterService {
    ...
    @Autowired
    public WaterServiceImpl(final WaterServiceRepository waterServiceRepository, final PriceRepository priceRepository) {
    ...
    public CalculatedCostResponse getUserCostsByUserIdAndMonth(final Integer userId, final LocalDate dateTime) {
        ...
        List<BigDecimal> listCosts = waterServiceRepository.getAmountOfResourcesByMonthAndUserId(userId,
    ...
    private List<LocalDate> createListOfAvailableDates(final Integer userId) {
        LocalDate minMonth = getStartOfTheMonth(waterServiceRepository.getMinMonth(userId));
        LocalDate maxMonth = getStartOfTheMonth(waterServiceRepository.getMaxMonth(userId));
