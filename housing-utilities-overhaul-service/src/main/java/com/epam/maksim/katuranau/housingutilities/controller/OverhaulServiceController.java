...
public class OverhaulServiceController {

    private OverhaulService overhaulService;

    @Autowired
    public OverhaulServiceController(final OverhaulService maintenanceService) {
        this.overhaulService = maintenanceService;
    }
    ...
    public CalculatedCostResponse calculate(@RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date,
        ...
        return overhaulService.getUserCostsByUserIdAndMonth(customPrincipal.getUserId(), date);
    }
}
